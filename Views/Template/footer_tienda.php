	<?php 
	 ...
	 ?>
	<!-- Footer -->
	<footer class="bg3 p-t-75 p-b-32" style="">
		<div class="container" style="border-left:100%">
			<div class="row">
...
<!--===============================================================================================-->
	...
	<script type="text/javascript" src="<?= media();?>/js/nutricion.js"></script>
	<script type="text/javascript" src="<?= media();?>/js/nitrogeno.js"></script>
	<script type="text/javascript" src="<?= media();?>/js/fosforo.js"></script>
	<script type="text/javascript" src="<?= media();?>/js/pesosuelo.js"></script>
	<script type="text/javascript" src="<?= media();?>/js/potasio.js"></script>
