    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li>
         ...
         <?php } ?>
		<?php if(!empty($_SESSION['permisos'][14]['r']) || !empty($_SESSION['permisos'][6]['r'])){ ?>            
            <li class="treeview">                
                <a class="app-menu__item" href="#" data-toggle="treeview">                    
                    <i class="app-menu__icon fa fa-cog" aria-hidden="true"></i>                   
                     <span class="app-menu__label">Asesoría</span>                    
                     <i class="treeview-indicator fa fa-angle-right"></i>                
                </a>                
                 <ul class="treeview-menu">
                    <?php if ($_SESSION['permisos'][14]['rolid'] != 3): ?>
                        <li>
                            <a class="treeview-item" href="<?= base_url(); ?>/asesorias">
                                <i class="icon fa fa-circle-o"></i> Preguntas
                            </a>
                        </li>                
                    <?php endif ?>                  
                                 
                    <li>
                        <a class="treeview-item" href="<?= base_url(); ?>/Asesorias/asesoriasguardadas/">
                            <i class="icon fa fa-circle-o"></i> Asesorías guardadas
                        </a>
                    </li>
                </ul>
            </li>
