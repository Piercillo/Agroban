...
<div id="app">
	<!-- Modal -->
	<div class="modal fade" id="modalAyuda"  tabindex="1101" aria-hidden="true">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="<?= base_url() ?>/nutricion" class="flex-c-m trans-04 p-lr-25">
							Registrate
						</a>
						<?php } ?>
					</div>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="<?= base_url(); ?>/crecimiento">Crecimiento</a>
							</li>
							...
							<li>
								<a href="<?= base_url(); ?>/fertilizacion">Fertilización</a>
							</li>
							...
							<li>
								<a href="<?= base_url(); ?>/contacto">Asesoria</a>
							</li>
						</ul>
					</div>	
			...
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						...
						<a href="<?= base_url() ?>/nutricion" class="flex-c-m p-lr-10 trans-04">
							Registrate
						</a>
						<?php } ?>
					</div>
