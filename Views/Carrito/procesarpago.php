		...
		<div class="row">
			<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					...
					?>
						<div>
							<label for="tipopago">Dirección del pedido</label>
							<div class="bor8 bg0 m-b-12">
								<input id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Dirección del pedido">
							</div>
							<div class="bor8 bg0 m-b-22">
								<input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Ciudad">
							</div>
						</div>
					<?php }else{ ?>
						...
						<div id="optMetodoPago" class="notblock">	
							...
							<div class="divmetodpago">
								...
								<div id="divtipopago" class="notblock" >
									...
									<br>
									<button type="submit" id="btnComprar" class="flex-c-m stext-101 cl12 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Procesar pedido</button>
								</div>
								<div id="divpaypal">
									<div>
